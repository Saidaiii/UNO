...
def goHelp():
  ...
  while helpV != "--resume":
    ...
    print("Skip: You can use these cards if the current play card is the same color, if it's also a Skip, or if it's a wild card and the color chosen is the same. This will skip the following players turn.")
    print("\nWild Cards: ")
    cprint("+4", 'grey', cc, end =" ")
    print("Draw 4: This card is the universal card. This card can be played on any other card as long as it is your turn. This will force the following player to draw 4 cards and skip his turn unless he also has a Draw 4 and decides to play it. This player will also choose what the following color may be. If the previous player drew 4 cards and the current player stacks another draw 4 on top, this will not stack since the last player already drew the previous stack.")
    cprint("☯", 'grey', cc, end =" ")
    print("Wild: You may use these cards to change the current color of the game. This card can be played on top of any card as long as it is your turn.\n\n")
